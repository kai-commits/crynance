...
export const CoinModal = ({
  ...
  return (
    <div className={classNames([ modalOpen ? 'animate-slideUp' : 'animate-slideDown', 'fixed z-[500] bottom-0 right-0 left-0 bg-offwhite rounded-t-lg max-w-3xl mx-auto pb-5 transition-all duration-1000' ])}>
